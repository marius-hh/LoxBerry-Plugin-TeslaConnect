...
?>
		...
		Step 4: Paste the copied web address here and press the <strong>Get Token</strong>-Button:<br>
		<input type="text" name="weburl" size="100" required><input type="submit" value="Get Token">
		</form>
...
<p>All data is transferred via MQTT. The subscription for this is <span class="mono">teslaconnect/#</span> and is automatically registered in the MQTT gateway plugin.</p>
...
?>
		...
		<p style="color:red"><b>MQTT gateway not installed!</b></p>
		
<?php
	} else {		
?>

		<p style="color:green"><b>MQTT gateway found and it will be used.</b></p>
